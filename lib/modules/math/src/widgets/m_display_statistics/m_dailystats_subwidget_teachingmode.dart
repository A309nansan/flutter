...
class MProblemStatTileTeachingMode extends StatefulWidget {
  final int index;
  final String mapKey;
  ...
  const MProblemStatTileTeachingMode({
    super.key,
    required this.index,
  ...
  @override
  State<MProblemStatTileTeachingMode> createState() =>
      _MProblemStatTileTeachingModeState();
}

class _MProblemStatTileTeachingModeState
    extends State<MProblemStatTileTeachingMode> {
          ...
          children: [
            ...
            Flexible(
              child:            ConstrainedBox(
                constraints: BoxConstraints(
                  maxHeight: max(rightBoxHeight + 50, 400),
                ),
                child: Container(
