...
class HandwritingData {
  ...
  HandwritingData({
    ...
    required this.ink,
    this.candidateDigit1 = 9999,
    this.candidateDigit2 = 9999,
    this.candidateDigit3 = 9999,
    this.candidateSimilarity1 = 1,
    this.candidateSimilarity2 = 1,
    this.candidateSimilarity3 = 1,
  });

  // handwriting_data.dart에 추가
