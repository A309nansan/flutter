...
class LevelOneTwoThreeMain4 extends ConsumerStatefulWidget {
  final String problemCode;
  const LevelOneTwoThreeMain4({super.key, required this.problemCode});

  @override
  // ✅ 상태변경 2. State -> ConsumerState
  ConsumerState<LevelOneTwoThreeMain4> createState() => _LevelOneTwoThreeMain4State();
}

// ✅ 상태변경 3. State -> ConsumerState
class _LevelOneTwoThreeMain4State extends ConsumerState<LevelOneTwoThreeMain4> with TickerProviderStateMixin {
