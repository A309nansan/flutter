...
import 'package:nansan_flutter/level_1/2_3/level_1_2_3_think2.dart';
...
import 'package:nansan_flutter/level_1/2_3/level_1_2_3_main2.dart';
import 'package:nansan_flutter/level_1/2_3/level_1_2_3_main3.dart';
import 'package:nansan_flutter/level_1/2_3/level_1_2_3_main4.dart';
import 'package:nansan_flutter/level_1/2_3/level_1_2_3_main5.dart';
import 'package:nansan_flutter/level_1/3_1/level_1_3_1_basic1.dart';
import 'package:nansan_flutter/level_1/3_2/screens/level_1_3_2_basic2.dart';
import 'package:nansan_flutter/level_1/3_2/screens/level_1_3_2_main2.dart';
import 'package:nansan_flutter/level_1/3_2/screens/level_1_3_2_main3.dart';
import 'package:nansan_flutter/level_1/3_2/screens/level_1_3_2_main4.dart';
import 'package:nansan_flutter/level_1/3_2/screens/level_1_3_2_pro1.dart';
...
import '1_4/level_1_1_4_think1.dart';
...
class En1Module extends Module {
  ...
  void routes(RouteManager r) {
    ...
    r.child(
      ...
      child: (context) {
        final nextCode = r.args.data as String;
        return LevelOneTwoOneMain2(problemCode: nextCode);
      },
    );
    // 2과 2차시 개념1
    r.child(
    ...
    r.child(
      ...
      child: (context) {
        final nextCode = r.args.data as String;
        return LevelOneTwoThreeThink2(problemCode: nextCode);
      },
    );
    // 2과 3차시 개념3
    r.child(
    ...
    r.child(
      ...
      child: (context) {
        final nextCode = r.args.data as String;
        return LevelOneTwoThreeMain2(problemCode: nextCode);
      },
    );
    // 2과 3차시 주요3
    r.child(
      ...
      child: (context) {
        final nextCode = r.args.data as String;
        return LevelOneTwoThreeMain3(problemCode: nextCode);
      },
    );
    // 2과 3차시 주요4
    r.child(
      ...
      child: (context) {
        final nextCode = r.args.data as String;
        return LevelOneTwoThreeMain4(problemCode: nextCode);
      },
    );
    // 2과 3차시 주요5
    r.child(
      ...
      child: (context) {
        final nextCode = r.args.data as String;
        return LevelOneTwoThreeMain5(problemCode: nextCode);
      },
    );
    // 3과 1차시 기초1
    r.child(
    ...
    r.child(
      ...
      child: (context) {
        final nextCode = r.args.data as String;
        return LevelOneThreeTwoBasic1(problemCode: nextCode);
      },
    );
    // 3과 2차시 기초2
    r.child(
      ...
      child: (context) {
        final nextCode = r.args.data as String;
        return LevelOneThreeTwoBasic2(problemCode: nextCode);
      },
    );
    // 3과 2차시 주요1
    r.child(
      ...
      child: (context) {
        final nextCode = r.args.data as String;
        return LevelOneThreeTwoMain1(problemCode: nextCode);
      },
    );
    // 3과 2차시 주요2
    r.child(
      ...
      child: (context) {
        final nextCode = r.args.data as String;
        return LevelOneThreeTwoMain2(problemCode: nextCode);
      },
    );
    // 3과 2차시 주요3
    r.child(
      ...
      child: (context) {
        final nextCode = r.args.data as String;
        return LevelOneThreeTwoMain3(problemCode: nextCode);
      },
    );
    // 3과 2차시 주요4
    r.child(
      ...
      child: (context) {
        final nextCode = r.args.data as String;
        return LevelOneThreeTwoMain4(problemCode: nextCode);
      },
    );
    // 3과 2차시 심화1
    r.child(
    ...
    r.child(
      ...
      child: (context) {
        final nextCode = r.args.data as String;
        return LevelOneThreeThreePro(problemCode: nextCode);
      },
    );
    // 4과 1차시 주요1
    r.child(
      ...
      child: (context) {
        final nextCode = r.args.data as String;
        return Level141main1(problemCode: nextCode);
      },
    );
    // 4과 1차시 주요2
    r.child(
      ...
      child: (context) {
        final nextCode = r.args.data as String;
        return Level141main2(problemCode: nextCode);
      },
    );
    // 4과 1차시 주요3
    r.child(
      ...
      child: (context) {
        final nextCode = r.args.data as String;
        return Level141main3(problemCode: nextCode);
      },
    );
    // 4과 1차시 주요4
    r.child(
      ...
      child: (context) {
        final nextCode = r.args.data as String;
        return Level141main4(problemCode: nextCode);
      },
    );
    // 4과 2차시 주요1
    r.child(
