...
class Level141main4 extends ConsumerStatefulWidget {
  final String problemCode;
  const Level141main4({super.key, required this.problemCode});

  @override
  // ✅ 상태변경 2. State -> ConsumerState
  ConsumerState<Level141main4> createState() => Level141main4State();
}

// ✅ 상태변경 3. State -> ConsumerState
class Level141main4State extends ConsumerState<Level141main4>
                                      ...
                                      Column(
                                        children: [
                                          NewQuestionTextWidget(
                                            questionText:
                                                '4. <보기>와 같이 사과가 $problemNumber개 되도록 오른쪽 사과주머니를 \n클릭하여 열고 빈칸에 알맞게 사과를 옮겨 보세요.',
                                            questionTextSize:
                                                screenWidth * 0.03,
                                          ),
                                          Container(
